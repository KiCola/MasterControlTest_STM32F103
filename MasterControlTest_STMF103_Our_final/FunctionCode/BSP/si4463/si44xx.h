...
U8 	 si446x_check_event(void);
void si446x_enter_rx(U8 channel, U8 packetLenght);
void si446x_send_packet(uint8_t channel, uint8_t *pioRadioPacket, uint8_t length);
unsigned char si446x_get_rssi(void);
U8 si446x_set_power(U8 power);//0x7F  是最大功率输出
#endif	/* __SI44XX_H__ */
